 ...
 *
 * Ограничение стиля — это его ограничение, а не его бестолковость. Стиль,
 * который не покупает модулей или не лечится вовсе, играет при этом
 * настолько грамотно, насколько позволяет запрет: так замер отвечает на
 * вопрос «проходимо ли это ограничение», а не «выживет ли неумеха». В
 * рогаликах такие забеги называют челленджами, и они проходимы — вопрос
 * только в том, какой ценой.
 *
 * Разбивка:
 *
