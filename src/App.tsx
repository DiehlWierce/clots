...
export default function App() {
  ...
  const endCycle = useCallback(() => {
    ...
    // Новый цикл начинается со «Штаба»: доход, энергия и события цикла
    // касаются именно его. Оставлять игрока на карте или в дереве развития
    // значит заставлять его возвращаться вручную каждый ход.
    setTab(HOME)
  }, [dispatch])
