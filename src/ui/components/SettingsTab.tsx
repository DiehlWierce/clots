    ...
    <>
      ...
      <section className="panel">
        ...
        <details className="fold">
          ...
          <p>
            И вы, и противник играете тремя приёмами: удар, замах и супер-удар. Замах — ход без
            урона, зато входящий удар придёт вполсилы, а ваш следующий пробьёт броню. Противник
            объявляет замах за ход до удара — это и есть момент, когда стоит замахнуться в ответ.
          </p>
        </details>
        <details className="fold">
