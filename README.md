...
- **Сложная экономика.** Улучшения эффективности добычи и грамотный риск-менеджмент.
- **Тактический бой.** Пошаговые столкновения с уникальными намерениями врагов в боевом режиме.
...
## Управление
- **Управление:** активные действия и ключевые показатели.
- **Карта:** исследование секторов и запуск боевых событий.
- **Развитие:** модули, доктрины и технологии добычи в виде дерева.
- **Бой:** отдельный боевой режим, перекрывающий экран при столкновении.
- **Журнал:** лог событий и оперативные уведомления.
- **Лор:** отдельная вкладка с эрами и главами истории.
